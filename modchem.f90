...
type (location) :: INERT, PRODUC , O3, O1D, NO2, NO, NO3, N2O5, HNO3, RH, R, ISO, RO2, H2O2, HO2, HO, CO, CO2, H2O, NH3, H2SO4, CH2O, CH3O2, MVK, TERP, OAbg, ISOPOOH, IEPOX, IEPOXSOA, SO2, APIN, BPIN, LIMO, APOH, APO3, APNO3, BPOH, BPO3, BPNO3, LIOH, LIO3, LINO3, ISO3, ISNO3
